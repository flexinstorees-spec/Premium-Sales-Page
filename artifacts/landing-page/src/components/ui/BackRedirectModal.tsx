        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Zap className="w-2.5 h-2.5 fill-white" /> Espera! Oferta Relâmpago
              </span>
            ...
            {/* Price + Items side by side */}
            <div className="flex" style={{ background: "#fff" }}>

              {/* Price */}
              <div
                className="flex flex-col items-center justify-center px-3 py-3 text-center shrink-0"
                style={{ background: "linear-gradient(180deg, #f0faf3, #e8f5ec)", borderRight: "1px solid #4a8e5820", minWidth: 120 }}
              >
                <div className="flex items-center gap-1 text-[10px] text-muted-foreground mb-0.5">
                  <span className="line-through font-semibold" style={{ color: "#ad674b99" }}>R$ 97</span>
                  <span>→</span>
                </div>
                <div className="flex items-baseline gap-0.5 leading-none">
                  <span className="font-bold text-sm" style={{ color: "#4a8e58" }}>R$</span>
                  <span className="font-extrabold" style={{ color: "#4a8e58", fontSize: "2.8rem", lineHeight: 1 }}>4</span>
                  <span className="font-bold text-sm" style={{ color: "#4a8e58" }}>,90</span>
                </div>
                <span
                  className="font-semibold text-[9px] px-2 py-0.5 rounded-full mt-1"
              ...
              <div className="flex-1 px-3 py-3">
                <p className="font-semibold text-[9px] tracking-wide uppercase mb-1.5" style={{ color: "#ad674b" }}>
                ...
                <div className="flex flex-col gap-1">
                  {items.map((item, i) => (
                    <div key={i} className="flex items-center gap-1.5">
                      ...
                      >
                        <Check className="w-1.5 h-1.5" strokeWidth={3} style={{ color: "#ad674b" }} />
                      </div>
                      <span className="font-light text-foreground text-[11px] leading-none">{item}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            {/* Stars row */}
            <div
              className="px-4 py-1.5 flex items-center justify-center gap-1"
            ...
            >
              <a
                ...
                className="w-full min-h-[46px] px-4 py-2.5 text-white font-bold rounded-full text-sm tracking-wide text-center flex items-center justify-center transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
                style={{
