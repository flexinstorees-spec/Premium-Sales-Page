      ...
      {open && (
        ...
        >
          ...
          >
            ...
            {/* Header */}
            <div
              className="px-5 pt-4 pb-3 text-center flex flex-col items-center gap-1.5"
            ...
            >
              ...
              <div className="flex items-baseline gap-1">
                <span className="font-sans font-bold text-lg" style={{ color: "#4a8e58" }}>R$</span>
                <span className="font-sans font-extrabold leading-none text-6xl" style={{ color: "#4a8e58" }}>14</span>
                <span className="font-sans font-bold text-lg" style={{ color: "#4a8e58" }}>,99</span>
              </div>
              <span className="font-sans text-xs text-muted-foreground font-light">à vista • acesso imediato</span>
            </div>

            {/* Items */}
            <div className="px-5 py-3 flex flex-col gap-2" style={{ background: "#fff" }}>
            ...
            {/* CTAs */}
            <div
              className="px-5 py-4 flex flex-col items-center gap-2.5"
            ...
            >
              ...
              <a
                ...
                className="w-full min-h-[52px] px-4 py-3 text-white font-bold rounded-full transition-all duration-300 active:scale-[0.98] text-sm tracking-wide text-center flex items-center justify-center"
                style={{
